...
If you use the dataset or code, please cite our [Paper](https://arxiv.org/) TODO update link
...
To download any of the datasets, you can find them at `<todo: facebook side><person_id>.tar`, where you can replace `<person_id>` with any of `PXB184`, `RLW104`, `TXB805`, or `GQS883`.
```
wget <TODO: frl side>
tar xvf <person_id>.tar --directory dataset/
rm <person_id>.tar
```
